...
When a TCP connection is made by a client, the server responds with the protocol versions it supports. __The server provides its public host key__, which the client can use to check whether this was the intended host.
